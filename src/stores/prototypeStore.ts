...
const defaultPages: PrototypePage[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        pageId: 'PersonnelTrajectory',
        pageName: '人员轨迹',
        pagePath: '/security/personnel-trajectory',
        modules: [
          {
            moduleId: 'pt-alert-list',
            moduleName: '告警事件列表',
            moduleType: 'table',
            pageId: 'PersonnelTrajectory',
            requirementId: 'pt-alert-list',
            bounds: { x: 0, y: 0, width: 0, height: 0 },
            props: {},
          },
          {
          ...
          },
          {
            ...
            moduleType: 'card',
            pageId: 'PersonnelTrajectory',
            requirementId: 'pt-target',
            bounds: { x: 0, y: 0, width: 0, height: 0 },
            props: {},
          },
          {
            moduleId: 'pt-timeline',
            moduleName: '抓拍时间线',
            moduleType: 'table',
            pageId: 'PersonnelTrajectory',
            requirementId: 'pt-timeline',
            bounds: { x: 0, y: 0, width: 0, height: 0 },
            props: {},
          },
          {
            moduleId: 'pt-snapshot-preview',
            moduleName: '抓拍预览',
            moduleType: 'form',
            pageId: 'PersonnelTrajectory',
            requirementId: 'pt-snapshot-preview',
            bounds: { x: 0, y: 0, width: 0, height: 0 },
            props: {},
          },
        ],
